...
import static cn.netinnet.generator.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/generator-code" + "/src/main/resources/generator/template";//模板位置
...
//
//        }
        //genCode("form_sell_order", "form_ship_notice","form_staff_profile","form_traval_submit");
        //genCode("form_material_inspection", "form_material_req","form_payment","form_produce_task","form_product_inhouse","form_product_inspection","form_purchase","form_purchase_order","form_sell_contract");
        genCode("wf_proc_def");
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        pluginConfiguration.setConfigurationType(ProjectConstant.PACKAGE + ".GenPlugin");
        pluginConfiguration.addProperty("mappers", MAPPER_INTERFACE_REFERENCE);
        context.addPluginConfiguration(pluginConfiguration);

        JavaModelGeneratorConfiguration javaModelGeneratorConfiguration = new JavaModelGeneratorConfiguration();
        javaModelGeneratorConfiguration.setTargetProject(PROJECT_PATH + "/" + MOUDLE + JAVA_PATH);
        javaModelGeneratorConfiguration.setTargetPackage(MODEL_PACKAGE);
        context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

        SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration = new SqlMapGeneratorConfiguration();
        sqlMapGeneratorConfiguration.setTargetProject(PROJECT_PATH + "/" + MOUDLE + JAVA_PATH );
        sqlMapGeneratorConfiguration.setTargetPackage(MAPPER_PACKAGE+".mapper");
        context.setSqlMapGeneratorConfiguration(sqlMapGeneratorConfiguration);

        JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
        javaClientGeneratorConfiguration.setTargetProject(PROJECT_PATH + "/" + MOUDLE + JAVA_PATH);
        ...
        commentGenerator.setConfigurationType(ProjectConstant.PACKAGE + ".GenCommentGenerator");
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            data.put("basePackageModule", BASE_PACKAGE_MODULE);
            data.put("commonPackage", COMMON_PACKAGE);
            data.put("module", MOUDLE);
            data.put("keyName", tableNameConvertUpperCamel(getPrimaryKeyName(tableName)));
            File file = new File(PROJECT_PATH + "/" + MOUDLE  + JAVA_PATH + PACKAGE_PATH_SERVICE + modelNameUpperCamel + "Service.java");
            ...
            File file1 = new File(PROJECT_PATH + "/" + MOUDLE  + JAVA_PATH + PACKAGE_PATH_SERVICE_IMPL + modelNameUpperCamel + "ServiceImpl.java");
    ...
    public static void genController(String tableName, String modelName) {
        try {
            ...
            File file = new File(PROJECT_PATH + "/" + MOUDLE  + JAVA_PATH + PACKAGE_PATH_CONTROLLER + modelNameUpperCamel + "Controller.java");
            if (!file.getParentFile().exists()) {
                file.getParentFile().mkdirs();
            }
