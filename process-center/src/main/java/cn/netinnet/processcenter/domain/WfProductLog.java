 ...
 * @date   2021-04-20
 **/
public class WfProductLog implements Serializable {
    /**
     * 记录id
     */
    ...
    private static final long serialVersionUID = 6304386040094093312L;

    /**
     * 获取记录id
     *
     * @return product_log_id - 记录id
     */
     ...
     * 获取操作： I 买入， O售出，B期初
     *
     * @return operation_flag - 操作： I 买入， O售出，B期初
     */
     ...
     * 设置操作： I 买入， O售出，B期初
     *
     * @param operationFlag 操作： I 买入， O售出，B期初
     */
    ...
    public String toString() {
        ...
        sb.append(", productLogId=").append(productLogId);
