 ...
 * @date   2021-04-20
 **/
public class WfMaterialLog implements Serializable {
    /**
     * 记录id
     */
    ...
    private static final long serialVersionUID = 5641150610448037888L;

    /**
     * 获取记录id
     *
     * @return material_log_id - 记录id
     */
    ...
    public String toString() {
        ...
        sb.append(", materialLogId=").append(materialLogId);
